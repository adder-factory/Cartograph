...
const EXPECTED_BM25_DOCUMENT_IDS: [&str; 5] = [
    ...
    "95cf3bb2-7390-8760-b682-a71081d9b5fd",
    "a5008cb5-184d-819e-a6bf-54c4f6207da0",
];
const EXPECTED_FILES: i64 = 28;
const EXPECTED_SYMBOLS: i64 = 3_840;
const EXPECTED_EDGES: i64 = 4_473;
const EXPECTED_REFERENCES: i64 = 12_651;
const EXPECTED_DOCUMENTS: i64 = 3_868;
...
const EXPECTED_RESOLVED_REFERENCES: u64 = 2_956;
const EXPECTED_UNRESOLVED_REFERENCES: u64 = 9_695;
const EXPECTED_MODELED_GENERATION_BYTES: u64 = 8_074_529;
const EXPECTED_RESOLVE_HIGH_WATER_BYTES: u64 = 56_600_216;
const EXPECTED_VALIDATION_HIGH_WATER_BYTES: u64 = 46_054_906;
