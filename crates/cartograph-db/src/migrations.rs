...
const LATEST_SCHEMA_VERSION: i64 = RUST_CLOSURE_CALL_TARGET_DIGEST_V11_SCHEMA_VERSION;
...
mod tests {
    ...
    const EXPECTED_MIGRATION_VERSIONS: [i64; 30] = [
    ...
    const EXPECTED_MIGRATION_CHECKSUMS: [(i64, &str); 30] = [
        (
            1,
