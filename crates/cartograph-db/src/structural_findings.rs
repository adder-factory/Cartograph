...
impl CartographDatabase {
    /// Report whether the stored current-generation detector relation matches
    /// every input in the exact fingerprint without recomputing or mutating it.
    pub(crate) async fn structural_finding_run_matches_current_inputs(
        &self,
