...
async function runSetupModelStep(
  ...
  try {
    ...
    await writeSetupRecommendedConfig(projectPath, deps);
  } catch (error_) {
...
async function writeSetupRecommendedConfig(projectPath: string, deps: LifecycleCommandDeps): Promise<void> {
