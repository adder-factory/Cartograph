...
export const reviewCmd = program
  .command('review')
  .description(
    'Review / triage helpers (mirrors cartograph_review MCP tool). Subcommands: context (diff-driven structural review) / neighbors (semantic lookalikes) / risk (project-wide triage).',
  );
