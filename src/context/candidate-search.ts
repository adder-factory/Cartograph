...
import { findNodesByExactName, findNodesByNameSubstring, searchNodes } from '../db/queries-search.js';
import { logDebug } from '../errors.js';
import { compact } from '../utils.js';
import { isDiagnosticPath } from '../path-class.js';
import type { ScoreTrace } from './score-trace.js';
...
import { HIGH_VALUE_NODE_KINDS, pickSearchKinds } from './options.js';
import {
...
import { resolveImportsToDefinitions } from './subgraph.js';
import {
  extractSearchTerms,
  getStemVariants,
  scorePathRelevance,
 ...
 */
export function collectAndScoreContextCandidates(st: ContextBuilderState, qargs: CandidateQueryArgs): SearchResult[] {
