...
import { searchNodes, getNodesByName, findSignatureTokenOwner } from '../../db/queries-search.js';
...
/**
 * Build the final output markdown from ask result, citations, and
 * model info. Splits verified citations into confirmed (source-tree)
 * and uncertain (dist-path-only) for accurate counter.
 */
