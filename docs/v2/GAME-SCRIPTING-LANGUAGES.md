...
Last implementation audit: 2026-08-08 (`v2.1.13`).

Research inventory last reviewed: 2026-08-02 (`v2.1.7`).

Cartograph v2.1.13 recognizes 128 native source-language modes. Seventy-three
...
introduced in v2.1.7, and WGSL and Metal were added in v2.1.12. Rhai is included
in the 52.
