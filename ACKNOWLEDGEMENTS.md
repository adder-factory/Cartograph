...
statement-id linkage, file-scoped symbol listing, `.ignore` indexing overrides
for gitignored local source, binary/invalid ignore-file resilience, GLSL shader
